...
import { AudioUploadImage, DraggableItemDelIcon, LessonTypeMusic, LessonTypeQuestion, LessonTypeText, LessonTypeVideo } from "assets/svg/icon";
    ...
    <>
      <div className="border rounded p-3 mb-4 bg-white">
        ...
        <div className="mt-4 w-50">
          <h5>Lesson Module</h5>
          <Input placeholder="Lesson Module Name" />
        </div>
        <div className="mt-4">
