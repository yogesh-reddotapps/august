  ...
  return (
    <Suspense fallback={<Loading cover="content" />}>
      <Switch>
        ...
        <Route exact path={`${APP_PREFIX_PATH}/course_curriculum/curriculum_list/curriculam_details/batch/classes/view_subjects/lessons/lesson_details/edit_assignment`} component={lazy(() => import(`./curriculum_list/batch/classes/view_subjects/lessons/lesson_details/add_new_assignment`))} />
        ...
        <Route exact path={`${APP_PREFIX_PATH}/masters/courses/subjects/edit`} component={lazy(() => import(`./masters/courses/subjects/add_new`))} />
        ...
        <Route exact path={`${APP_PREFIX_PATH}/masters/courses/subjects/lessons/edit`} component={lazy(() => import(`./masters/courses/subjects/lessons/add_new`))} />
