    ...
    <div>
      <div className="p-3 mb-4 bg-white">
        ...
        >
          ...
          <div>
            <div>
              <h5 className="m-0">Lesson Module</h5>
              <p className="m-0">Overview of Construction Safety</p>
            </div>
          </div>
          <Divider style={{ height: "60px" }} type="vertical" />
          <div>
            <div>
              <h5 className="m-0">Estimated Time</h5>
              <p className="m-0">60 Mins</p>
            </div>
          </div>
        </div>
      </div>
      <div className="border rounded p-3 mb-4 bg-white">
        ...
        <p style={{color:"black"}}>
          ...
          industry. Lorem Ipsum has been the industry's standard Lorem Ipsum is
          simply dummy text of the printing and typesetting industry. Lorem
          Ipsum has been the industry's standard Lorem Ipsthe industry's
          standard
        </p>
      </div>
    </div>
