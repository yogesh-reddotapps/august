              ...
              return (
                <>
                  <EllipsisDropdown menu={
                    <Menu>
                      <Menu.Item>
                        <Link to='/app/assessment/submission' > <DeleteOutlined className="mr-2 " />Delete</Link >
                      </Menu.Item>
                      <Menu.Item>
                        <Link to={`event_list/update/${record.id}`} className='d-flex align-items-center' ><CustomIcon className='mr-2' svg={Edit} />Edit</Link>
                      </Menu.Item>
                      <Menu.Item>
                        <Link to={`assignment/submission`} className='d-flex align-items-center' ><CustomIcon className='mr-2' svg={Edit} />View Submissions</Link>
                        {/* <Link to={`assignment/submission/${record.id}`} className='d-flex align-items-center' ><CustomIcon className='mr-2' svg={Edit} />View Submissions</Link> */}
                      </Menu.Item>
                    </Menu>
                  } />
